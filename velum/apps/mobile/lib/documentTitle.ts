...
const BY_PREFIX: { prefix: string; title: string }[] = [
  ...
  { prefix: '/blind-tasting', title: 'Dégustation à l’aveugle' },
  { prefix: '/event-sommelier', title: 'Sommelier d’événement' },
  { prefix: '/community', title: 'Communauté' },
  { prefix: '/arbiter', title: 'Arbitre patrimonial' },
