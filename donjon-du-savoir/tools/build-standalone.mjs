...
const MODULES = [
  ...
  "wordgames", "themes", "langues", "state", "board", "data", "voiceclips", "voixdirect", "cartes", "constellations", "visuels", "sonmystere", "eclair", "ui", "scene", "models3d", "board3d", "souvenir", "version", "game", "app",
];
